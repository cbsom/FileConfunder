...
namespace Confunder
{
    internal static class Program
    {
        ...
        private static readonly string _key = LoadSettings().Key;
...
USAGE: 
    ...
    [-silent] No console output and on Windows the command window is hidden.";
        ...
        private static bool ProcessArgs(string[] args)
        {
            ...
            {
                var legalActions = new string[] { "confund", "unconfund", "run", "help" };
                var action = args[Array.IndexOf(args, "-action") + 1];
        ...
        {
            public string Key { get; set; } = "fnwrkUFPnw9GuxubyIrQu+5ENJND3g947zsmcknbAYQ=";
        }
    }
}
